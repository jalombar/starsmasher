...
StarSmasher now also builds on macOS with Apple Silicon using Metal. If you are installing on an Apple Silicon Mac, follow the [Apple Silicon installation guide](./installation_applesilicon.md) instead of the Linux/NVIDIA prerequisites in this section.
