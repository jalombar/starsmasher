...
c     particles per cell)
         ...
         write(69,*)'using integral=',integral
...
c     (particle is accepted)    
                        ip=ip+1                 
                        if(rtry.le.a1) then
                           write(69,'(4i5,4e12.4)')ip,ix,iy,iz,
     $                          xtry,ytry,ztry,rtry
                        endif
                        x(ip)=xtry        
                        y(ip)=ytry            
...
c      call reset_h
      ...
      enddo
      write(69,*) 'using cc=',cc(1),'for all sph particles'
      cc(ntot)=1
...
c     prepare leap-frog scheme for first iteration:
      ...
      write(69,*)'polymces.f: about to call lfstart'
...
c      ee=21.97824502596553d0    !gives a coremass of 0.3
      ee=24.707161583d0         !gives a coremass of 0.25
...
c      ee=45.480816d0            !gives a coremass of +0
...
c      write(69,*) 'starting with', ystart(1),ystart(2)
     ...
     $     rkqs)
      ...
      write(69,*)'polymc: kount=',kount
      write(69,35)'ir    ','xtab    ','ytab    ','yptab    '
...
c      ak=0.424188107d0
      if(yp1.eq.0.d0)then
         write(69,*)'should be:'
         write(69,*)'xi_1 = 3.65375'
         write(69,*)'y_1 = 0'
         write(69,*)'xi_1*yprime = 2.71406'
         write(69,*)
         write(69,*)'actual:'
         write(69,*)'xi_1 = ',x1
         write(69,*)'alpha_1 = ',ybothtab(1,1)
         write(69,*)'xi_1*alphaprime = ',yp1
         write(69,*)
      endif
      
      write(69,*)'k = ',ak
      write(69,*)'e=',(an+1)**an*x1**(an+1)*(-yp1/x1**2)**(an-1)
      coremass=4.d0*pi*a**3.d0*rhoc*ypc !,am*yp1/dabs(yps)
      write(69,*)'core mass: ',coremass

      if(corepts.eq.0) then
         write(69,*)'changing to coremass=0'
         coremass=0
      endif

      write(69,*)'total mass: ',4.d0*pi*a**3.d0*rhoc*dabs(yp1)!,am
      write(69,*)'total radius: ',r
...
c     hnext is an estimation for the next stepsize
 ...
 10   call rkck(y,dydx,n,x,h,ytemp,yerr,derivsmc)
      ...
      if(errmax.gt.1)then
         ...
         xnew=x+h
         if(xnew.eq.x) then
            write(69,*) 'rkqs: stepsize underflow',x,y
         endif
         goto 10
      else
