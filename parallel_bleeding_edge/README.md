...
```
To get the StarSmasher density unit in g/cm^3, in StarSmasher units 
(where R_sun = M_sun = G = 1): 

Density_unit = M_sun / R_sun^3 = (1.9891e33 g) / (6.9599e10 cm)^3 = 5.906 g/cm^3.

So multiply any code density value by 5.906 to get g/cm^3.
...
ConversionFactorDensity  = 5.906     # To get g/cm^3
```
