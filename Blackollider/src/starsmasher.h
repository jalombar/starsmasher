      ...
      real*8 trelax,sep0,t,tf,dtout,dt,dth,hco,hfloor,hceiling,tscanon,sepfinal
      ...
      real*8 grpot(nmax),meanmolecular(nmax),f(nmax),bb(nmax),aa(nmax),zeta(nmax),dd(nmax)
      real*8 vxdot(nmax),vydot(nmax),vzdot(nmax),udot(nmax)
      real*8 gx(nmax),gy(nmax),gz(nmax),tthermal(nmax),ueq(nmax)
      integer nn(nmax),list(nnmax*nmax),first(nmax)
      ...
      real*8 omega2,omega_spin,AACONST,BBCONST
      ...
      common/intpar/ dt,n,nnopt,hco,hfloor,hceiling,dth,AACONST,BBCONST,ntot
      common/out/ t,tf,dtout,nout,nit     
      common/wtabul/dgdhtab,dgtab,gtab,wtab,dwtab,ctab,dwdhtab,dphidhtab
      common/part/ x,y,z,vx,vy,vz,am,hp,u,rho,por2,grpot,f,bb,aa,zeta,dd
      common/dyn/ vxdot,vydot,vzdot,udot,gx,gy,gz,tthermal,ueq
      integer kdm
      common/neigh/ nn,list,first
      real*8 meanmolecularweight	
      common/radpress/ meanmolecular,redge,meanmolecularweight
      ...
      common/adiabaticindex/ gam,npoly
      integer maxnumx
