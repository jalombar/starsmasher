...
from the directory where you want the installation to occur (in what follows, I'll assume the installation was done in the subdirectory starsmasher of your home directory).
Create a folder,
...
so that you're in the src subdirectory.  
Then
...
Although this Starsmasher code is not well documented, there is documentation for Starcrash, which is a previous version of this code (see http://ciera.northwestern.edu/StarCrash/).  
...
The algorithms of Starsmasher are mostly described in http://adsabs.harvard.edu/abs/2010MNRAS.402..105G.  
