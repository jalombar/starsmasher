...
public:
   ...
   my_dev::dev_mem<int> atomicValues;   //The atomics we use during various stages
                                        //atomicValues[0] , block counter in tree-walk
                                        //atomicValues[1] , mutex on the big stack of tree-walk
                                        //atomicValues[2] 
                                        //atomicValues[3]                                         
...
//   void approximate_gravity(tree_structure &tree);
  ...
  */
  ...
  void  approximate_gravity(tree_structure &tree,
                                 ...
                                 my_dev::dev_mem<int>     &j_bodies_ids,  //IDs of tree-particles
                                 my_dev::dev_mem<float4>  &i_bodies_pos,  //Bodies that are part of the groups
                                 my_dev::dev_mem<float4>  &i_bodies_h,
                                 my_dev::dev_mem<int>     &i_bodies_ids,  //IDS of group particles
                                 int n_groupBodies,                       //Number of bodies that are part of the groups
  ...
  void get_ngb(tree_structure &tree,
                      my_dev::dev_mem<float4>  &j_bodies_pos,  //Bodies that are part of the tree-structure
